...
import Facebook from '../icons/travels/IconFacebook.vue'
import Twitter from '../icons/travels/IconTwitter.vue'
import Instagram from '../icons/travels/IconInstagram.vue'
</script>
